...
export default async function ReservationPage() {
  ...
  return (
    <>
      <HeroSection
        header={<StackedHeader main="When" subtext="can you come?" />}
      >
        <BaseHeroSubHeader
          text="Currently we are only allowing 10 people every 30 minutes, so make
          sure to reserve a spot!"
        />
      </HeroSection>
              ...
              {events.map((event) => (
                ...
                >
                  <div className="flex grow flex-col">
                    ...
                    {event.description ? (
                      <p className="mt-3 grow text-sm text-gray-700">
                        {event.description}
                      </p>
                    ) : (
                      <div className="grow" />
