...
export default async function FaqPage() {
  ...
  const faqs = [
    ...baseFaqs,
    {
      ...
      answers: schools.length ? schools : ["School list is currently unavailable."],
    },
    {
  ...
  return (
    <div className="screen-width-border screen-height-border mx-auto w-full max-w-6xl">
      <h1 className="text-center text-4xl font-semibold text-secondary">How</h1>
      <h2 className="text-center text-3xl font-semibold text-primary">can we help?</h2>
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-2">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6">
          <h2 className="text-2xl font-semibold">Haven&apos;t found the right help?</h2>
          <p className="mt-2 text-gray-600">Send us a message and we will get back to you.</p>
          <ContactUsForm />
        </div>
      </div>
    </div>
